...
TemporalAIntersectsGeometryLogicalFunction::TemporalAIntersectsGeometryLogicalFunction(
...
bool TemporalAIntersectsGeometryLogicalFunction::operator==(const TemporalAIntersectsGeometryLogicalFunction& rhs) const
{
...
TemporalAIntersectsGeometryLogicalFunction TemporalAIntersectsGeometryLogicalFunction::withDataType(const DataType& dataType) const
{
    auto copy = *this;
...
TemporalAIntersectsGeometryLogicalFunction TemporalAIntersectsGeometryLogicalFunction::withChildren(const std::vector<LogicalFunction>& children) const
{
    PRECONDITION(children.size() == 4 || children.size() == 6,
                 "TemporalAIntersectsGeometryLogicalFunction requires 4 or 6 children, but got {}", children.size());
    auto copy = *this;
...
Reflected Reflector<TemporalAIntersectsGeometryLogicalFunction>::operator()(const TemporalAIntersectsGeometryLogicalFunction& function) const
{
    detail::ReflectedTemporalAIntersectsGeometryLogicalFunction reflected;
...
TemporalAIntersectsGeometryLogicalFunction Unreflector<TemporalAIntersectsGeometryLogicalFunction>::operator()(const Reflected& reflected) const
{
    auto r = unreflect<detail::ReflectedTemporalAIntersectsGeometryLogicalFunction>(reflected);

    if (!r.param0.has_value() || !r.param1.has_value() || !r.param2.has_value() || !r.param3.has_value())
    {
        throw CannotDeserialize("TemporalAIntersectsGeometryLogicalFunction is missing required children");
    }

    if (r.param4.has_value() && r.param5.has_value())
    {
        return TemporalAIntersectsGeometryLogicalFunction{r.param0.value(), r.param1.value(), r.param2.value(),
                                                          r.param3.value(), r.param4.value(), r.param5.value()};
    }
    return TemporalAIntersectsGeometryLogicalFunction{r.param0.value(), r.param1.value(), r.param2.value(), r.param3.value()};
}
...
LogicalFunctionRegistryReturnType LogicalFunctionGeneratedRegistrar::RegisterTemporalAIntersectsGeometryLogicalFunction(LogicalFunctionRegistryArguments arguments)
{
    ...
    {
        return unreflect<TemporalAIntersectsGeometryLogicalFunction>(arguments.reflected);
    }

    if (arguments.children.size() == 4)
    {
        return TemporalAIntersectsGeometryLogicalFunction(arguments.children[0], arguments.children[1],
