...
VarVal NearestApproachDistancePhysicalFunction::execute(const Record& record, ArenaRef& arena) const {
    ...
    auto lon1 = parameterValues[0].getRawValueAs<nautilus::val<double>>();
    auto lat1 = parameterValues[1].getRawValueAs<nautilus::val<double>>();
    auto ts1  = parameterValues[2].getRawValueAs<nautilus::val<uint64_t>>();
    auto lon2 = parameterValues[3].getRawValueAs<nautilus::val<double>>();
    auto lat2 = parameterValues[4].getRawValueAs<nautilus::val<double>>();
    auto ts2  = parameterValues[5].getRawValueAs<nautilus::val<uint64_t>>();
